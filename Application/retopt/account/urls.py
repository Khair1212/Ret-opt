...
urlpatterns = [
    ...
    path('analyst_register/', views.analyst_register, name='analyst_register'),
    ...
    path('password-reset-confirm/<uidb64>/<token>/',
         auth_views.PasswordResetDoneView.as_view(template_name='account/password_reset_confirm.html'),
